...
const about = {
    title: "About Me",
    description: "I am a full-stack software developer with a passion for crafting elegant digital experiences." +
...
const education = {
    ...
    title: "Education",
    description: "I am currently studying at Mahidol University International College.",
    items: [
        {
            ...
            <div className="container mx-auto">
                <Tabs
                    ...
                    <div className="min-h-[70vh] w-full">
                        ...
                        {/* education */}
                        <TabsContent value="education" className="max-w-full">
                            <div className="flex flex-col gap-[30px] text-center xl:text-left">
